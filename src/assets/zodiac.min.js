  ...
  new Zodiac('zodiac',
    {
      ...
      density: 35295,                     // px^2 per node
      dotRadius: [4.7, 9.5],                   // px value or [minR,maxR]
      backgroundColor: '#000',      // default transparent; use alpha value for motion blur and ghosting
      dotColor: '#e1486c',
      linkColor: '#000',
      linkDistance: 0,
      linkWidth: 2
